...
.circle {
            width: 20px; /* Đặt chiều rộng của hình tròn */
            height: 20px; /* Đặt chiều cao của hình tròn */
            background-color: #4CAF50; /* Màu nền của hình tròn (màu xanh lá cây) */
            border-radius: 50%; /* Đặt border-radius để tạo hình tròn */
            display: flex; /* Sử dụng flex để căn giữa nội dung */
            align-items: center; /* Căn giữa theo chiều dọc */
            justify-content: center; /* Căn giữa theo chiều ngang */
            color: white; /* Màu của biểu tượng (trắng) */
...
.box {
    ...
    width: 80%; /* Giới hạn chiều rộng của box */
    max-width: 1200px; /* Đảm bảo box không quá rộng */
...
<div class="main">
    ...
    <div class="info">
        ...
        <h2><?=$sp->price ?></h2><span>(Đã bao gồm VAT)</span>
...
<!-- sp tuong tu -->
 <div class="sptt"><h1>Sản phẩm tương tự</h1>

<div class="boxall">

<?php foreach ($all as $key){ if($key->category_id == $sp-> category_id){ ?>
        <div class="tt" id="b" >
