                        ...
                        <tbody>
                            ...
                            foreach ($all as $key): ?>
                                <tr>
                                    ...
                                    <td><?= $key->nameUser ?></td>
                                    <td>
                                        <?= number_format($key->total_amount) . "đ" ?>
                                    </td>
                                    <td>
                                        <?php
                                        if ($key->status == "pending") {
                                            echo '<span class="badge text-bg-danger" >Chờ xử lý</span>';
                                        } else if ($key->status === "shipped") {
                                            echo '<span class="badge text-bg-success" >Đã giao</span>';
                                        } else {
                                            echo '<span class="badge text-bg-dark" >Đã hủy</span>';
                                        } ?>
                                    </td>
